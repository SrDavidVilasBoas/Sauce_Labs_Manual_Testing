...
Feature: Login
    ...
    Scenario: Login Happy Path
        ...
        When I insert a valid username "standard_user" in the "Username" field
    ...
    Scenario: Loging in with invalid username
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I insert a invalid username "thebruh" in the "Username" field
        And insert a valid password "secret_sauce" in the "Password" field
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username and password do not match any user in this service"

    Scenario: Loging in with invalid password
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I insert a valid username "standard_user" in the "Username" field
        And insert a invalid password "thebruh123" in the "Password" field
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username and password do not match any user in this service"
    ...
    Scenario: Case sensitivity in the "Username" field
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When insert a valid username with wrong letter's case "Standard_user" in the "Username" field
        And Insert a valid password "secret_sauce" in the "Password" field
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username and password do not match any user in this service"
    ...
    Scenario: Case sensitivity in the "Password" field
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When insert a valid username "standard_user" in the "Username" field
        And Insert a valid password with wrong letter's case "Secret_sauce" in the "Password" field
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username and password do not match any user in this service"

    Scenario: Both blank fill-in fields
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I let the "Username" field blank
        And I let the "Password" field blank
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username is required"

    Scenario: Blank fill-in "Username" field
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I let the "Username" field blank
        And insert a valid password "secret_sauce" in the "Password" field
    ...
    Scenario: Blank fill-in "Password" field
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I insert a valid username "standard_user" in the "Username" field
        And I let the "Password" field blank
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Password is required"

    Scenario: Switch "Password" and "Username" fill-in fields
        Given I'm on the website "https://www.saucedemo.com/"
        And the internet connection is on
        When I insert a valid password "secret_sauce" in the "Username" field
        And insert a valid username "standard_user" in the "Password" field
        And click on the "Login" button
        Then the login fails
        And an error message appears "Epic sadface: Username and password do not match any user in this service"
...
Feature: Add to Cart
    ...
    Scenario: Remove cart item
        ...
        And the removed item isn't in the cart
    ...
    Scenario: Item's picture matches relatively to the item's description
        ...
        Then both the item's image and description are related
...
Feature: Filter
    ...
    Scenario: Z-A
        ...
        Then items' names are displayed in inverted alphabectical order
    ...
    Scenario: Low-high price
        ...
        Then items' prices are arranged from low to high
    ...
    Scenario: High-low price
        ...
        Then items' prices are arranged from high to low
...
Feature: Checkout
    ...
    Scenario: Fist Checkout page Happy path
        ...
        Then "Continue" button navigates to "/checkout-step-two.html" with the "Checkout: Overview"

    Scenario: Second Checkout page Happy path
        Given I'm on the website "https://www.saucedemo.com/checkout-step-two.html"
        And the internet connection is on
        When click on "Finish" button in the lower right corner
        Then the "Thank" page is displayed
    ...
    Scenario: "Back Home" Button
        Given I'm on the website "https://www.saucedemo.com/checkout-complete.html"
        And the internet connection is on
        When at the "Thank" page, click on the lower centered "Back home" button
...
Feature: Navigation Menu
    ...
    Scenario: About
        ...
        When click on the three lines 'Navegation Menu' upper left corner
        And click on "About"
        Then when clicked, it brings me until "https://saucelabs.com/" page
